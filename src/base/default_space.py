...
class DefaultSpace:
    ...
    def __init__(self, dbms, test, timeout, seed=1):
        self.dbms = dbms
        ...
        self.penalty = 10
        self.default_throughput, self.default_average_latency = self.get_default_result()
    ...
    def set_and_replay(self, config, weight, seed=0):
        begin_time = time.time()
        cost = self.set_and_replay_ori(config, weight, seed)
        end_time = time.time()
        self._log(begin_time, end_time)
        return cost


    def set_and_replay_ori(self, config, weight, seed=0):
        self.round += 1
        ...
        return (1-weight)*(throughput-self.default_throughput)/self.default_throughput + weight*(self.default_average_latency-average_latency)/self.default_average_latency
